...
var chunk_HNOCAIKC_exports = {};
__export(chunk_HNOCAIKC_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_HNOCAIKC_exports);
...
[Context: getDmmf]`;
    super((0, import_chunk_J3JTMPWZ.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_P47PM3SY.prismaSchemaWasm.get_dmmf(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
