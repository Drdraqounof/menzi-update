...
var chunk_G6VGFCRW_exports = {};
__export(chunk_G6VGFCRW_exports, {
...
module.exports = __toCommonJS(chunk_G6VGFCRW_exports);
...
var import_chunk_T6BPU44Y = require("./chunk-T6BPU44Y.js");
var import_chunk_KJKLC73N = require("./chunk-KJKLC73N.js");
var import_chunk_EIO44IYO = require("./chunk-EIO44IYO.js");
var import_chunk_6JD4VENT = require("./chunk-6JD4VENT.js");
var import_chunk_QMSPMDFJ = require("./chunk-QMSPMDFJ.js");
...
async function formatSchema({ schemas }, inputFormattingOptions) {
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(() => {
      import_chunk_QMSPMDFJ.prismaSchemaWasm.debug_panic();
    });
  }
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(() => {
    ...
    const lintDiagnostics2 = (0, import_chunk_T6BPU44Y.lintSchema)({ schemas: formattedMultipleSchemas2 });
    return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
  });
  const lintWarnings = (0, import_chunk_T6BPU44Y.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_QMSPMDFJ.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function processSchemaResult({
  ...
  const configFromPsl = await (0, import_chunk_EIO44IYO.getConfig)({ datamodel: schemaResult.schemas });
...
async function getGenerators(options) {
  ...
  const dmmf = await (0, import_chunk_6JD4VENT.getDMMF)({
...
You need to define \`output\` in the generator block in the schema file.`
        ...
        const datamodel = (0, import_chunk_KJKLC73N.mergeSchemas)({ schemas: schemaContext.schemaFiles });
        const options2 = {
          datamodel,
